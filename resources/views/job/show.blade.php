...
<article class="max-w-4xl mx-auto bg-[#F7FAFF] p-2 sm:p-6 mb-4 rounded-lg shadow-md">
    <div class="mb-6">
    ...
    <tbody>
        <tr class="border-b-[0.5px] border-gray-300">
            <td class="font-semibold py-2 px-1 sm:px-4 w-28">会社名</td>
            <td class="py-2 px-4">{!! nl2br(e($article->company_name)) !!}</td>
        </tr>
        <tr class="border-b-[0.5px] border-gray-300">
            <td class="font-semibold py-2 px-1 sm:px-4 w-28">所在地</td>
            <td class="py-2 px-4">{!! nl2br(e($article->address)) !!}</td>
        </tr>
        <tr class="border-b-[0.5px] border-gray-300">
            <td class="font-semibold py-2 px-1 sm:px-4 w-28">勤務地</td>
            <td class="py-2 px-4">{!! nl2br(e($article->work_location)) !!}</td>
        </tr>
        <tr class="border-b-[0.5px] border-gray-300">
            <td class="font-semibold py-2 px-1 sm:px-4 w-28">職種</td>
            <td class="py-2 px-4">{!! nl2br(e($article->job_title)) !!}</td>
        </tr>
        <tr class="border-b-[0.5px] border-gray-300">
            <td class="font-semibold py-2 px-1 sm:px-4 w-28">アクセス</td>
            <td class="py-2 px-4">{!! nl2br(e($article->access)) !!}</td>
        </tr>
        <tr class="border-b-[0.5px] border-gray-300">
            <td class="font-semibold py-2 px-1 sm:px-4 w-28">雇用形態</td>
            <td class="py-2 px-4">{!! nl2br(e($article->employment_type)) !!}</td>
        </tr>
        <tr class="border-b-[0.5px] border-gray-300">
            <td class="font-semibold py-2 px-1 sm:px-4 w-28">仕事内容</td>
            <td class="py-2 px-4">{!! nl2br(e($article->job_description)) !!}</td>
        </tr>
        <tr class="border-b-[0.5px] border-gray-300">
            <td class="font-semibold py-2 px-1 sm:px-4 w-28">給与</td>
            <td class="py-2 px-4">{!! nl2br(e($article->salary)) !!}</td>
        </tr>
        <tr class="border-b-[0.5px] border-gray-300">
            <td class="font-semibold py-2 px-1 sm:px-4 w-28">待遇</td>
            <td class="py-2 px-4">{!! nl2br(e($article->treatment)) !!}</td>
        </tr>
        <tr class="border-b-[0.5px] border-gray-300">
            <td class="font-semibold py-2 px-1 sm:px-4 w-28">勤務時間</td>
            <td class="py-2 px-4">{!! nl2br(e($article->working_hours)) !!}</td>
        </tr>
        <tr class="border-b-[0.5px] border-gray-300">
            <td class="font-semibold py-2 px-1 sm:px-4 w-28">募集条件</td>
            <td class="py-2 px-4">{!! nl2br(e($article->recruitment_conditions)) !!}</td>
        </tr>
        <tr class="border-b-[0.5px] border-gray-300">
            <td class="font-semibold py-2 px-1 sm:px-4 w-28">休日/休暇</td>
            <td class="py-2 px-4">{!! nl2br(e($article->holidays)) !!}</td>
        </tr>
        <tr class="border-b-[0.5px] border-gray-300">
            <td class="font-semibold py-2 px-1 sm:px-4 w-28">応募方法</td>
            <td class="py-2 px-4">{!! nl2br(e($article->application_method)) !!}</td>
        </tr>
        <tr class="border-b-[0.5px] border-gray-300">
            <td class="font-semibold py-2 px-1 sm:px-4 w-28">面接地</td>
            <td class="py-2 px-4">{!! nl2br(e($article->interview_location)) !!}</td>
        </tr>
        <tr>
            <td class="font-semibold py-2 px-1 sm:px-4 w-28">受付担当者</td>
