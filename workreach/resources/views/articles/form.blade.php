...
<div class="form-group bg-gray-100 p-5">
    ...
    <textarea rows="6" id="application_method" name="application_method" class="form-control w-full rounded-xl">{{ old('application_method', $article->application_method) }}</textarea rows="6">
</div>
