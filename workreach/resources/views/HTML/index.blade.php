...
<div class="relative mb-8 max-w-6xl mx-auto bg-[#F7FAFF]">
            <img src="{{ asset('storage/images/top.jpeg') }}" alt="画像1" class="w-full">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <a href="/genre/full-time.html">
                    <img src="{{ asset('storage/images/oldImg/img/photo-1-1.jpg') }}" alt="カード1の画像" class="w-full h-48 object-cover">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <a href="/genre/part-job.html">
                    <img src="{{ asset('storage/images/oldImg/img/photo-2-2.jpg') }}" alt="カード2の画像" class="w-full h-48 object-cover">
                    <div class="p-4 text-center">
                        <h5 class="text-lg font-semibold">パート・アルバイト</h5>
                    </div>
                </a>
            </div>
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <a href="/genre/health.html">
                    <img src="{{ asset('storage/images/oldImg/img/medical-photo-2.jpg') }}" alt="カード3の画像" class="w-full h-48 object-cover">
                    <div class="p-4 text-center">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <a href="/genre/construction.html">
                    <img src="{{ asset('storage/images/oldImg/img/build-photo-2.jpg') }}" alt="カード4の画像" class="w-full h-48 object-cover">
                    <div class="p-4 text-center">
                        <h5 class="text-lg font-semibold">ドライバー・建築</h5>
                    </div>
                </a>
            </div>
        </div>
