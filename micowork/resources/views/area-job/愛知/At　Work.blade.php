...
<div id="job-listing">
    <div class="job-info">
        <div class="job-detail">
            <ul class="genre-list">
            <li class="genre-1">愛知</li>
            <li class="genre-2">軽作業</li>
            <li class="genre-3">その他</li>
            </ul>
        <h2 class="job-title">株式会社　At　Work / 梱包・結束、玉掛作業</h2>
    </div>
        <img class="job-image" src="/src/detail-img/愛知/株式会社　At　Work : 梱包・結束、玉掛作業.png" alt="求人画像">
    ...
    <table class="job-details">
        ...
        <tr>
            <td>所在地</td>
            <td>〒441-3436 愛知県田原市白浜２号１番地３</td>
        </tr>
        <tr>
            <td>勤務地</td>
            <td>株式会社 Ａｔ Ｗｏｒｋ<br>
                〒441-3436 愛知県田原市白浜２号１番地３<br>
                東京製鐵株式会社 田原工場内 日通東愛知運輸株式会社
            </td>
        </tr>
        <tr>
            <td>職種</td>
        ...
        <tr>
            <td>仕事内容</td>
            <td>オープニングのため、スタートが同じです。<br>
                楽しく働ける環境です。<br><br>
                
                工場から出てきた製品（コイル）を紙で梱包。<br>
                玉掛けの作業もあります。<br>
                変更範囲：変更なし
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>年齢制限<br>
                ...
                法令の規定により年齢制限がある<br>
                年齢制限の理由<br>
                １８歳以上（１６歳以上の男性可　労働基準法第６１条　深夜業）<br>
                学歴<br>
                不問<br>
                必要な経験等<br>
                不問<br>
        ...
        <tr>
            <td>応募方法</td>
            <td>電話 応募<br>
                「Mico work を見た」と言って頂けるとスムーズにお繋ぎすることができます。
            </td>
        </tr>
        <tr>
            <td>面接地</td>
            <td>〒473-0901 愛知県豊田市御幸本町２－２０３－４　オフィス９８－３Ｂ</td>
        </tr>
        <tr>
            <td>受付担当</td>
            <td>所長</td>
    ...
    <p class="call">応募先電話番号：<a href="tel:090-7433-9359">090-7433-9359</a></p>
