...
<div id="job-listing">
    <div class="job-info">
        <div class="job-detail">
            ...
            <li class="genre-2">医療・介護・福祉</li>
            <li class="genre-3">パート</li>
            </ul>
        <h2 class="job-title">合同会社ケアステーション・れい / 訪問介護員</h2>
    </div>
        <img class="job-image" src="/src/detail-img/愛知/合同会社ケアステーション・れい : 訪問介護員.jpeg" alt="求人画像">
    <p class="job-description"></p>
    <table class="job-details">
        <tr>
            <td>会社名</td>
            <td>合同会社ケアステーション・れい</td>
        </tr>
        <tr>
            <td>所在地</td>
            <td>〒454-0985<br>
                愛知県名古屋市中川区春田３丁目５６番地<br>
                マンションＧＡＩＡ２０３</td>
        </tr>
        <tr>
            <td>勤務地</td>
        ...
        <tr>
            ...
            <td>最寄り駅<br>
                ＪＲ春田駅<br>
                最寄り駅から就業場所までの交通手段<br>
                徒歩<br>
                所要時間<br>
                1分<br>
                就業場所に関する特記事項<br>
                事務所は春田ですが、支援に入る場所は、利用者様宅<br>
                （春田近辺）になります</td>
        </tr>
        <tr>
            <td>雇用形態</td>
        ...
        <tr>
            <td>仕事内容</td>
            <td>利用者様宅にて、お買い物、お掃除、調理<br>
                入浴見守りが多いです。<br>
                移動支援事業は障害のある方の通学支援（朝の学校への送り）<br>
                余娯支援（プロレス観戦同行、カラオケ同行）<br>
                等あります</td>
        </tr>
        <tr>
            <td>給与</td>
        ...
        <tr>
            <td>勤務時間</td>
            <td>7時00分〜18時00分の時間の間の4時間程度<br>
                就業時間に関する特記事項<br>就業時間応相談</td>
        </tr>
        <tr>
            <td>募集条件</td>
            <td>年齢	<br>
    ...
    <p class="call">電話で応募する：<a href="tel:052-364-8488">052-364-8488</a></p>
